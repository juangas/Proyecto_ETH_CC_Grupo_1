...
function Terms() {
	...
	return (
		...
		<div className="container vh-100 overflow-auto">
			...
			<p>You are authorized to use this site for personal and non-commercial purposes. You must not violate any applicable laws, rules, or regulations when accessing or using this site.</p>
			<p><strong>3. Intellectual Property</strong></p>
			<p>The content, design, and all intellectual property associated with this site are the exclusive property of "CodeCrypto-EthereumTeamProject-Team1". You are authorized to view and download material only for personal and non-commercial use.</p>
			<p><strong>4. Privacy</strong></p>
			<p>The personal information you provide when using this site is subject to our privacy policy, which you can review at this link <a href="/privacy">here</a></p>
			...
			<p>We reserve the right to modify these terms and conditions at any time. Modifications will be effective immediately after being published on the site.</p>
			<p><strong>7. Limitation of Liability</strong></p>
			<p>In no event shall we be liable for direct, indirect, incidental, special, or consequential damages resulting from the use or inability to use this site.</p>
